class CompanyNameForm extends BaseForm {
  ...
  getFormHtml(headerEnable) {
    ...
    html += '<div class="row p-4">'
        ...
        + '           <label class="form-label font-label prvt-entity" style="display:none;">1. Company name (English) <span class="red">*</span></label>'
        + '           <label class="form-label font-label non-prvt-entity" style="display:none;">1. Submission No. <span class="red">*</span></label>'
        + '           <input id="entityName" class="plc reg-form-input form-control"/>'
        + '        </div>'
        + '        <div class="d-flex flex-column w-100 mb-4">'
        + '           <label class="form-label font-label prvt-entity" style="display:none;">2. Company name (Bangla) <span class="red">*</span></label>'
        + '           <label class="form-label font-label non-prvt-entity" style="display:none;">2. Name clearance letter no. <span class="red">*</span></label>'
