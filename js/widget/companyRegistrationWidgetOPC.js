$.widget("obrs.companyRegistrationWidget", {
    ...
    _create: function () {
       ...
       /* $(document).ready(function(){
        ...
        self.getCommonDataForFormElement(function(){
            ...
            Obrs.APP.SELECTED_VALUES.SELECTED_ENTITY_TYPE = "7";
            $('.qualified-share').hide();
        });
    },
    _init: function () {
    ...
    getFormObject: function(parentObject, stepObject){
        ...
        } else if (stepObject.code === 'NOMINEE_FORM') {
            return new NomineeForm(stepObject.header, stepObject.header, []);    
        }
    },
